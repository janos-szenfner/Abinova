...
static struct AbiStockMapping {
  ...
  { ABIWORD_FILE_CLOSE,				AP_MENU_ID_FILE_CLOSE,			"window-close-symbolic" },
...
//  { ABIWORD_FMT_CHOOSE,             (_Ap_Menu_Id)0,                 GTK_STOCK_SELECT_FONT },
...
abi_stock_init (void)
{
	...
	gtk_icon_theme_add_resource_path(gtk_icon_theme_get_for_display(gdk_display_get_default()), "/io/github/janos_szenfner/Abinova");
}
