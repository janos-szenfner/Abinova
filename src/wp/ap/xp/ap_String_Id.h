...
dcl(DLG_PageFormat_Executive,		"Executive")
dcl(DLG_PageFormat_8_5x13,			"8.5x13")
...
dcl(DLG_MetaData_LastSavedBy_LBL, "Last saved by:")
dcl(DLG_MetaData_Manager_LBL, "Manager:")
dcl(DLG_MetaData_Company_LBL, "Company:")
dcl(DLG_MetaData_Template_LBL, "Template:")
dcl(DLG_MetaData_Status_LBL, "Status:")
dcl(DLG_MetaData_TAB_Statistics, "Statistics")
dcl(DLG_MetaData_Created_LBL, "Created:")
dcl(DLG_MetaData_Modified_LBL, "Modified:")
dcl(DLG_MetaData_Printed_LBL, "Last printed:")
dcl(DLG_MetaData_Revision_LBL, "Revision:")
dcl(DLG_MetaData_EditingTime_LBL, "Total editing time:")
dcl(DLG_MetaData_Pages_LBL, "Pages:")
dcl(DLG_MetaData_Words_LBL, "Words:")
dcl(DLG_MetaData_Characters_LBL, "Characters:")
dcl(DLG_MetaData_Paragraphs_LBL, "Paragraphs:")
dcl(DLG_MetaData_Lines_LBL, "Lines:")
...
dcl(DLG_InsertHyperlink_DisplayLabel, "Text to display:")
dcl(DLG_InsertHyperlink_AddressLabel, "Address:")
...
dcl(MENU_LABEL_FILE_PROPERTIES, "Document Pro&perties")
...
dcl(MENU_LABEL_INSERT_COVERPAGE, "Cover &Page")
dcl(MENU_LABEL_INSERT_BLANKPAGE, "B&lank Page")
dcl(MENU_LABEL_INSERT_PAGEBREAK, "Page &Break")
dcl(MENU_LABEL_INSERT_PICTURES, "P&ictures")
dcl(MENU_LABEL_INSERT_SHAPES, "Sh&apes")
dcl(MENU_LABEL_INSERT_ICONS, "&Icons")
dcl(MENU_LABEL_INSERT_3DMODELS, "3&D Models")
dcl(MENU_LABEL_INSERT_SCREENSHOT, "Screensh&ot")
dcl(MENU_LABEL_INSERT_MEDIA, "Medi&a")
dcl(MENU_LABEL_INSERT_WORDART, "Word&Art")
dcl(MENU_LABEL_EQUATION_DISPLAY, "&Display")
dcl(MENU_LABEL_INSERT_DROPCAP, "Drop Ca&p")
dcl(MENU_LABEL_INSERT_SIGNATURE, "Signature &Line")
dcl(MENU_LABEL_INSERT_OBJECT, "&Object")
...
dcl(MENU_LABEL_FMT_GROWFONT,"Grow Font")
dcl(MENU_LABEL_FMT_SHRINKFONT,"Shrink Font")
dcl(MENU_LABEL_FMT_CLEARFMT,"Cl&ear Formatting")
dcl(MENU_LABEL_FMT_FRAME,"Text Box")
dcl(MENU_LABEL_LAYOUT_MARGINS,"Margins")
dcl(MENU_LABEL_LAYOUT_ORIENTATION,"Orientation")
dcl(MENU_LABEL_LAYOUT_SIZE,"Size")
dcl(MENU_LABEL_LAYOUT_BREAKS,"Breaks")
dcl(MENU_LABEL_LAYOUT_LINENUMBERS,"Line Numbers")
dcl(MENU_LABEL_LAYOUT_HYPHENATION,"Hyphenation")
dcl(MENU_LABEL_LAYOUT_POSITION,"Position")
dcl(MENU_LABEL_LAYOUT_WRAP,"Wrap Text")
dcl(MENU_LABEL_LAYOUT_BRINGFORWARD,"Bring Forward")
dcl(MENU_LABEL_LAYOUT_SENDBACKWARD,"Send Backward")
dcl(MENU_LABEL_LAYOUT_SELPANE,"Selection Pane")
dcl(MENU_LABEL_LAYOUT_ALIGNOBJECTS,"Align")
dcl(MENU_LABEL_LAYOUT_GROUPOBJECTS,"Group")
dcl(MENU_LABEL_LAYOUT_ROTATE,"Rotate")
dcl(MENU_LABEL_REF_TOCPOP,"Table of Contents")
dcl(MENU_LABEL_REF_ADDTEXT,"Add Text")
dcl(MENU_LABEL_REF_NEXTFN,"Next Footnote")
dcl(MENU_LABEL_REF_SHOWNOTES,"Show Notes")
dcl(MENU_LABEL_REF_UPDATETOC,"Update Table")
dcl(MENU_LABEL_REF_CITATION,"Insert Citation")
dcl(MENU_LABEL_REF_BIBLIOGRAPHY,"Bibliography")
dcl(MENU_LABEL_REF_SOURCES,"Manage Sources")
dcl(MENU_LABEL_REF_CAPTION,"Insert Caption")
dcl(MENU_LABEL_REF_TOF,"Insert Table of Figures")
dcl(MENU_LABEL_REF_XREF,"Cross-reference")
dcl(MENU_LABEL_REF_INSERTINDEX,"Insert Index")
dcl(MENU_LABEL_REF_MARKENTRY,"Mark Entry")
dcl(MENU_LABEL_REF_UPDATEINDEX,"Update Index")
dcl(MENU_LABEL_REF_REMOVEINDEX,"Remove Index")
dcl(MENU_LABEL_REF_INSERTTOA,"Insert Table of Authorities")
dcl(MENU_LABEL_REF_MARKCIT,"Mark Citation")
dcl(MENU_LABEL_REF_UPDATETOA,"Update Table")
dcl(MENU_LABEL_REF_REMOVETOA,"Remove Table of Authorities")
dcl(MENU_LABEL_REF_DELSOURCE,"Delete Source")
dcl(MENU_LABEL_REF_REMOVEBIB,"Remove Bibliography")
...
dcl(MENU_LABEL_TOOLS_SPELLING_MENUPOP,"Spelling and &Grammar")
...
dcl(MENU_LABEL_TOOLS_REVISIONS_MENUPOP_TRACK,"Track &Changes")
dcl(MENU_LABEL_TOOLS_REVISIONS_MENUPOP_DISPLAY,"&All Markup")
dcl(MENU_LABEL_TOOLS_REVISIONS_MENUPOP_ACCEPT,"&Accept")
dcl(MENU_LABEL_TOOLS_REVISIONS_MENUPOP_REJECT,"&Reject")
dcl(MENU_LABEL_TOOLS_REVISIONS_MENUPOP_COMPARE,"&Compare")
dcl(MENU_LABEL_TOOLS_REVISIONS_COMBINE_DOCUMENTS,"Com&bine Documents...")
dcl(MENU_LABEL_TOOLS_REVISIONS_PANE,"Reviewing &Pane")
...
dcl(MENU_LABEL_TOOLS_ANNOTATIONS_INSERT,"New &comment")
dcl(MENU_LABEL_TOOLS_ANNOTATIONS_INSERT_FROMSEL,"Create from &selection")
dcl(MENU_LABEL_TOOLS_ANNOTATIONS_NEXT,"N&ext comment")
dcl(MENU_LABEL_TOOLS_ANNOTATIONS_PREV,"&Previous comment")
dcl(MENU_LABEL_TOOLS_ANNOTATIONS_DELETE,"&Delete comment")
dcl(MENU_LABEL_TOOLS_ANNOTATIONS_DELETE_ALL,"Delete &all comments")
dcl(MENU_LABEL_TOOLS_ANNOTATIONS_RESOLVE,"Resol&ve comment")
dcl(MENU_LABEL_TOOLS_ANNOTATIONS_MENUPOP_DELETE,"&Delete")
dcl(MENU_LABEL_TOOLS_ANNOTATIONS_MENUPOP_SHOW,"&Show comments")
dcl(MENU_LABEL_TOOLS_ANNOTATIONS_TOGGLE_DISPLAY,"&Show comments")
...
dcl(MENU_LABEL_TABLE_VIEW_GRIDLINES, "View Gridlines")
dcl(MENU_LABEL_TABLE_DRAW, "Draw Table")
dcl(MENU_LABEL_TABLE_ERASE, "Eraser")
dcl(MENU_LABEL_TABLE_DISTRIBUTE_ROWS, "Distribute Rows")
dcl(MENU_LABEL_TABLE_DISTRIBUTE_COLS, "Distribute Columns")
dcl(MENU_LABEL_TABLE_TEXT_DIRECTION, "Text Direction")
dcl(MENU_LABEL_TABLE_CELL_MARGINS, "Cell Margins")
dcl(MENU_LABEL_TABLE_ALIGN_TOPLEFT, "Align Top Left")
dcl(MENU_LABEL_TABLE_ALIGN_TOPCENTER, "Align Top Center")
dcl(MENU_LABEL_TABLE_ALIGN_TOPRIGHT, "Align Top Right")
dcl(MENU_LABEL_TABLE_ALIGN_CENTERLEFT, "Align Center Left")
dcl(MENU_LABEL_TABLE_ALIGN_CENTER, "Align Center")
dcl(MENU_LABEL_TABLE_ALIGN_CENTERRIGHT, "Align Center Right")
dcl(MENU_LABEL_TABLE_ALIGN_BOTLEFT, "Align Bottom Left")
dcl(MENU_LABEL_TABLE_ALIGN_BOTCENTER, "Align Bottom Center")
dcl(MENU_LABEL_TABLE_ALIGN_BOTRIGHT, "Align Bottom Right")
dcl(MENU_LABEL_TABLE_AUTOFIT_CONTENTS, "AutoFit Contents")
dcl(MENU_LABEL_TABLE_AUTOFIT_WINDOW, "AutoFit Window")
dcl(MENU_LABEL_TABLE_AUTOFIT_FIXED, "Fixed Column Width")
...
dcl(MENU_LABEL_WINDOW_MENUPOP_SWITCH,"Switch &Windows")
dcl(MENU_LABEL_WINDOW_ARRANGE,"&Arrange All")
dcl(MENU_LABEL_VIEW_GRIDLINES,"&Gridlines")
...
dcl(MENU_LABEL_HELP_CHANGELOG, "Change&log")
...
dcl(MENU_STATUSLINE_INSERT_COVERPAGE, "Insert a designed cover page at the start of the document")
dcl(MENU_STATUSLINE_INSERT_BLANKPAGE, "Insert a new blank page at the cursor")
dcl(MENU_STATUSLINE_INSERT_PAGEBREAK, "Insert a page break")
dcl(MENU_STATUSLINE_INSERT_PICTURES, "Insert a picture from this device or online")
dcl(MENU_STATUSLINE_INSERT_SHAPES, "Insert a ready-made shape")
dcl(MENU_STATUSLINE_INSERT_ICONS, "Browse and insert stock icons")
dcl(MENU_STATUSLINE_INSERT_3DMODELS, "Insert a 3D-style illustration")
dcl(MENU_STATUSLINE_INSERT_SCREENSHOT, "Capture an area of the screen and insert it")
dcl(MENU_STATUSLINE_INSERT_MEDIA, "Insert audio or video")
dcl(MENU_STATUSLINE_INSERT_WORDART, "Insert decorative text")
dcl(MENU_STATUSLINE_INSERT_EQUATION, "Insert an equation")
dcl(MENU_STATUSLINE_EQUATION_DISPLAY, "Toggle between inline and display equation")
dcl(MENU_STATUSLINE_INSERT_DROPCAP, "Add a large dropped capital letter")
dcl(MENU_STATUSLINE_INSERT_SIGNATURE, "Add a signature line")
dcl(MENU_STATUSLINE_INSERT_OBJECT, "Insert an embedded object")
...
dcl(MENU_STATUSLINE_FMT_GROWFONT,"Increase the font size")
dcl(MENU_STATUSLINE_FMT_SHRINKFONT,"Decrease the font size")
dcl(MENU_STATUSLINE_FMT_CLEARFMT,"Remove direct formatting from the selection")
dcl(MENU_STATUSLINE_FMT_FRAME,"Change the properties of the Text Box")
dcl(MENU_STATUSLINE_LAYOUT_MARGINS,"Choose preset margins or set custom margins")
dcl(MENU_STATUSLINE_LAYOUT_ORIENTATION,"Switch between portrait and landscape page orientation")
dcl(MENU_STATUSLINE_LAYOUT_SIZE,"Choose a paper size for the document")
dcl(MENU_STATUSLINE_LAYOUT_BREAKS,"Insert page, column and section breaks")
dcl(MENU_STATUSLINE_LAYOUT_LINENUMBERS,"Add line numbers to the document")
dcl(MENU_STATUSLINE_LAYOUT_HYPHENATION,"Hyphenate the text in the document")
dcl(MENU_STATUSLINE_LAYOUT_POSITION,"Position the selected object on the page")
dcl(MENU_STATUSLINE_LAYOUT_WRAP,"Change how text wraps around the selected object")
dcl(MENU_STATUSLINE_LAYOUT_BRINGFORWARD,"Bring the selected object forward one level")
dcl(MENU_STATUSLINE_LAYOUT_SENDBACKWARD,"Send the selected object back one level")
dcl(MENU_STATUSLINE_LAYOUT_SELPANE,"Show the Selection Pane listing objects in the document")
dcl(MENU_STATUSLINE_LAYOUT_ALIGNOBJECTS,"Align the selected object on the page")
dcl(MENU_STATUSLINE_LAYOUT_GROUPOBJECTS,"Group the selected objects together")
dcl(MENU_STATUSLINE_LAYOUT_ROTATE,"Rotate or flip the selected object")
dcl(MENU_STATUSLINE_REF_TOCPOP,"Insert or manage the table of contents")
dcl(MENU_STATUSLINE_REF_ADDTEXT,"Set the level at which the current paragraph appears in the table of contents")
dcl(MENU_STATUSLINE_REF_NEXTFN,"Move to the next or previous footnote or endnote")
dcl(MENU_STATUSLINE_REF_SHOWNOTES,"Move to the footnote or endnote text")
dcl(MENU_STATUSLINE_REF_UPDATETOC,"Regenerate the table of contents at the cursor")
dcl(MENU_STATUSLINE_REF_CITATION,"Add a citation to a bibliography source")
dcl(MENU_STATUSLINE_REF_BIBLIOGRAPHY,"Insert a bibliography of all sources")
dcl(MENU_STATUSLINE_REF_SOURCES,"Manage the list of bibliography sources")
dcl(MENU_STATUSLINE_REF_CAPTION,"Insert a numbered caption for a figure, table or equation")
dcl(MENU_STATUSLINE_REF_TOF,"Insert a list of the captions in the document")
dcl(MENU_STATUSLINE_REF_XREF,"Insert a reference to a heading, bookmark or page")
dcl(MENU_STATUSLINE_REF_INSERTINDEX,"Insert an index of the marked entries")
dcl(MENU_STATUSLINE_REF_MARKENTRY,"Mark the selection as an index entry")
dcl(MENU_STATUSLINE_REF_UPDATEINDEX,"Regenerate the index from the marked entries")
dcl(MENU_STATUSLINE_REF_REMOVEINDEX,"Remove the index from the document")
dcl(MENU_STATUSLINE_REF_INSERTTOA,"Insert a table of authorities of the marked citations")
dcl(MENU_STATUSLINE_REF_MARKCIT,"Mark the selection as a legal citation")
dcl(MENU_STATUSLINE_REF_UPDATETOA,"Regenerate the table of authorities")
dcl(MENU_STATUSLINE_REF_REMOVETOA,"Remove the table of authorities")
dcl(MENU_STATUSLINE_REF_DELSOURCE,"Remove a source from the bibliography")
dcl(MENU_STATUSLINE_REF_REMOVEBIB,"Remove the bibliography")
...
dcl(MENU_STATUSLINE_TOOLS_SPELLING_MENUPOP,"Check spelling and grammar")
...
dcl(MENU_STATUSLINE_TOOLS_REVISIONS_MENUPOP_TRACK,"Track document changes")
dcl(MENU_STATUSLINE_TOOLS_REVISIONS_MENUPOP_DISPLAY,"Choose how revisions are displayed")
dcl(MENU_STATUSLINE_TOOLS_REVISIONS_MENUPOP_ACCEPT,"Accept revisions")
dcl(MENU_STATUSLINE_TOOLS_REVISIONS_MENUPOP_REJECT,"Reject revisions")
dcl(MENU_STATUSLINE_TOOLS_REVISIONS_MENUPOP_COMPARE,"Compare or combine documents")
dcl(MENU_STATUSLINE_TOOLS_REVISIONS_COMBINE_DOCUMENTS,"Combine revisions from another document into this one")
dcl(MENU_STATUSLINE_TOOLS_REVISIONS_PANE,"Toggle the reviewing pane")
// RIVERA
dcl(MENU_STATUSLINE_TOOLS_ANNOTATIONS,"Manage annotations in document")
dcl(MENU_STATUSLINE_TOOLS_ANNOTATIONS_INSERT,"Insert a comment")
dcl(MENU_STATUSLINE_TOOLS_ANNOTATIONS_INSERT_FROMSEL,"Insert selected text into a new annotation")
dcl(MENU_STATUSLINE_TOOLS_ANNOTATIONS_NEXT,"Go to the next comment")
dcl(MENU_STATUSLINE_TOOLS_ANNOTATIONS_PREV,"Go to the previous comment")
dcl(MENU_STATUSLINE_TOOLS_ANNOTATIONS_DELETE,"Delete the comment at the insertion point")
dcl(MENU_STATUSLINE_TOOLS_ANNOTATIONS_DELETE_ALL,"Delete all comments in the document")
dcl(MENU_STATUSLINE_TOOLS_ANNOTATIONS_RESOLVE,"Mark the comment at the insertion point as resolved")
dcl(MENU_STATUSLINE_TOOLS_ANNOTATIONS_MENUPOP_DELETE,"Delete comments")
dcl(MENU_STATUSLINE_TOOLS_ANNOTATIONS_MENUPOP_SHOW,"Show or hide comments")
dcl(MENU_STATUSLINE_TOOLS_ANNOTATIONS_TOGGLE_DISPLAY,"Show/hide comments")
...
dcl(MENU_STATUSLINE_TABLE_VIEW_GRIDLINES, "Show table cell boundaries on screen")
dcl(MENU_STATUSLINE_TABLE_DRAW, "Draw a table by dragging with the pointer")
dcl(MENU_STATUSLINE_TABLE_ERASE, "Erase table borders to merge cells")
dcl(MENU_STATUSLINE_TABLE_DISTRIBUTE_ROWS, "Make the selected rows the same height")
dcl(MENU_STATUSLINE_TABLE_DISTRIBUTE_COLS, "Make the selected columns the same width")
dcl(MENU_STATUSLINE_TABLE_TEXT_DIRECTION, "Change the text direction in the cell")
dcl(MENU_STATUSLINE_TABLE_CELL_MARGINS, "Set the padding inside the cells")
dcl(MENU_STATUSLINE_TABLE_ALIGN_TOPLEFT, "Align cell content to the top left")
dcl(MENU_STATUSLINE_TABLE_ALIGN_TOPCENTER, "Align cell content to the top center")
dcl(MENU_STATUSLINE_TABLE_ALIGN_TOPRIGHT, "Align cell content to the top right")
dcl(MENU_STATUSLINE_TABLE_ALIGN_CENTERLEFT, "Align cell content to the center left")
dcl(MENU_STATUSLINE_TABLE_ALIGN_CENTER, "Align cell content to the center")
dcl(MENU_STATUSLINE_TABLE_ALIGN_CENTERRIGHT, "Align cell content to the center right")
dcl(MENU_STATUSLINE_TABLE_ALIGN_BOTLEFT, "Align cell content to the bottom left")
dcl(MENU_STATUSLINE_TABLE_ALIGN_BOTCENTER, "Align cell content to the bottom center")
dcl(MENU_STATUSLINE_TABLE_ALIGN_BOTRIGHT, "Align cell content to the bottom right")
dcl(MENU_STATUSLINE_TABLE_AUTOFIT_CONTENTS, "Resize columns to fit their contents")
dcl(MENU_STATUSLINE_TABLE_AUTOFIT_WINDOW, "Stretch the table to the page width")
dcl(MENU_STATUSLINE_TABLE_AUTOFIT_FIXED, "Keep the current column widths")
...
dcl(MENU_STATUSLINE_WINDOW_MENUPOP_SWITCH,"Switch between open document windows")
dcl(MENU_STATUSLINE_WINDOW_ARRANGE,"Tile all open windows on the screen")
dcl(MENU_STATUSLINE_VIEW_GRIDLINES,"Show gridlines in the document area")
...
dcl(MENU_STATUSLINE_HELP_CHANGELOG, "Show what is new and what changed in each version")
...
dcl(TOOLBAR_LABEL_SORT_PARA,"Sort")
...
dcl(TOOLBAR_LABEL_LISTS_DASHED,"Dash list")
...
dcl(TOOLBAR_STATUSLINE_SORT_PARA,"Sort paragraphs alphabetically")
...
dcl(TOOLBAR_STATUSLINE_LISTS_DASHED,"Dash list")
...
dcl(TOOLBAR_TOOLTIP_SORT_PARA,"Sort Paragraphs")
...
dcl(TOOLBAR_TOOLTIP_LISTS_DASHED,"Dash list")
