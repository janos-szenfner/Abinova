...
menuitem(VIEW_WEB)
menuitem(VIEW_PRINT)
menuitem(VIEW_GRIDLINES)
menuitem(VIEW_NAVPANE)
menuitem(VIEW_SPLIT)
menuitem(INSERT)
...
menuitem(INSERT_COVERPAGE)
menuitem(INSERT_BLANKPAGE)
menuitem(INSERT_PAGEBREAK)
menuitem(INSERT_PICTURES)
menuitem(INSERT_SHAPES)
menuitem(INSERT_ICONS)
menuitem(INSERT_3DMODELS)
menuitem(INSERT_SCREENSHOT)
menuitem(INSERT_MEDIA)
menuitem(INSERT_WORDART)
menuitem(INSERT_EQUATION)
menuitem(EQUATION_DISPLAY)
menuitem(INSERT_DROPCAP)
menuitem(INSERT_SIGNATURE)
menuitem(INSERT_OBJECT)
...
menuitem(FMT_FRAME)
menuitem(LAYOUT_MARGINS)
menuitem(LAYOUT_ORIENTATION)
menuitem(LAYOUT_SIZE)
menuitem(LAYOUT_BREAKS)
menuitem(LAYOUT_LINENUMBERS)
menuitem(LAYOUT_HYPHENATION)
menuitem(LAYOUT_POSITION)
menuitem(LAYOUT_WRAP)
menuitem(LAYOUT_BRINGFORWARD)
menuitem(LAYOUT_SENDBACKWARD)
menuitem(LAYOUT_SELPANE)
menuitem(LAYOUT_ALIGNOBJECTS)
menuitem(LAYOUT_GROUPOBJECTS)
menuitem(LAYOUT_ROTATE)
menuitem(REF_TOCPOP)
menuitem(REF_ADDTEXT)
menuitem(REF_NEXTFN)
menuitem(REF_SHOWNOTES)
menuitem(REF_UPDATETOC)
menuitem(REF_CITATION)
menuitem(REF_BIBLIOGRAPHY)
menuitem(REF_SOURCES)
menuitem(REF_CAPTION)
menuitem(REF_TOF)
menuitem(REF_XREF)
menuitem(REF_INSERTINDEX)
menuitem(REF_MARKENTRY)
menuitem(REF_UPDATEINDEX)
menuitem(REF_REMOVEINDEX)
menuitem(REF_INSERTTOA)
menuitem(REF_MARKCIT)
menuitem(REF_UPDATETOA)
menuitem(REF_REMOVETOA)
menuitem(REF_DELSOURCE)
menuitem(REF_REMOVEBIB)
menuitem(FMT)
menuitem(FMT_BOLD)
menuitem(FMT_ITALIC)
...
menuitem(FMT_GROWFONT)
menuitem(FMT_SHRINKFONT)
menuitem(FMT_CLEARFMT)
...
menuitem(TOOLS_SPELLING_MENUPOP)
...
menuitem(TOOLS_REVISIONS_MENUPOP_TRACK)
menuitem(TOOLS_REVISIONS_MENUPOP_DISPLAY)
menuitem(TOOLS_REVISIONS_MENUPOP_ACCEPT)
menuitem(TOOLS_REVISIONS_MENUPOP_REJECT)
menuitem(TOOLS_REVISIONS_MENUPOP_COMPARE)
menuitem(TOOLS_REVISIONS_COMBINE_DOCUMENTS)
menuitem(TOOLS_REVISIONS_PANE)
...
menuitem(TOOLS_ANNOTATIONS_NEXT)
menuitem(TOOLS_ANNOTATIONS_PREV)
menuitem(TOOLS_ANNOTATIONS_DELETE)
menuitem(TOOLS_ANNOTATIONS_DELETE_ALL)
menuitem(TOOLS_ANNOTATIONS_RESOLVE)
menuitem(TOOLS_ANNOTATIONS_MENUPOP_DELETE)
menuitem(TOOLS_ANNOTATIONS_MENUPOP_SHOW)
...
menuitem(TABLE_VIEW_GRIDLINES)
menuitem(TABLE_DRAW)
menuitem(TABLE_ERASE)
menuitem(TABLE_DISTRIBUTE_ROWS)
menuitem(TABLE_DISTRIBUTE_COLS)
menuitem(TABLE_TEXT_DIRECTION)
menuitem(TABLE_CELL_MARGINS)
menuitem(TABLE_ALIGN_TOPLEFT)
menuitem(TABLE_ALIGN_TOPCENTER)
menuitem(TABLE_ALIGN_TOPRIGHT)
menuitem(TABLE_ALIGN_CENTERLEFT)
menuitem(TABLE_ALIGN_CENTER)
menuitem(TABLE_ALIGN_CENTERRIGHT)
menuitem(TABLE_ALIGN_BOTLEFT)
menuitem(TABLE_ALIGN_BOTCENTER)
menuitem(TABLE_ALIGN_BOTRIGHT)
menuitem(TABLE_AUTOFIT_CONTENTS)
menuitem(TABLE_AUTOFIT_WINDOW)
menuitem(TABLE_AUTOFIT_FIXED)
