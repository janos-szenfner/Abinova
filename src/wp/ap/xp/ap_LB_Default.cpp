...
// ********************************************************************************
// ********************************************************************************
// *** THIS FILE DEFINES THE DEFAULT KEYBOARD AND MOUSE BINDINGS FOR Abinova 1. ***
...
//						  "",					"",					"",				""					}},
	...
	{EV_NVK_F5,			{ "go",					"",					"",				"",
						  "",					"",					"",				""					}},
	{EV_NVK_F6,			{ "",					"",					"cycleWindows",	"cycleWindowsBck",
						  "",					"",					"",			""					}},
#ifdef ENABLE_SPELL
	{EV_NVK_F7,			{ "dlgSpell",			"",					"",				"",
						  "",					"",					"",				""					}},
...
//						  "",					"",					"",				""					}},
	...
	{EV_NVK_F11,		{ "viewFullScreen",					"",					"",				"",
						  "",					"",					"",				""					}},
	{EV_NVK_F12,		{ "fileSaveAs",			"fileSave",			"fileOpen",		"print",
						  "",				        "",					"",				""					}},
// 	{EV_NVK_F13,		{
// 	{EV_NVK_F14,		{
// 	{EV_NVK_F15,		{
...
//	{char, /* desc   */ { none,					_C,					_A,				_A_C				}},
	...
	{0x2b, /* +      */ { "insertData",			"toggleSuper",		"",				""					}},
	{0x2c, /* ,      */ { "insertData",			"dlgOptions",		"",				""					}},
	{0x2d, /* -      */ { "insertData",			"insertSoftHyphen",	"",				"insertEmDash"		}},
	{0x2e, /* .      */ { "insertData",			"pasteSpecial",		"",				""					}},
	{0x2f, /* /      */ { "insertData",			"",					"",				""					}},
	{0x30, /* 0      */ { "insertData",			"toggleParaBefore",	DO_NOT_USE,		""					}},
	...
	{0x3a, /* :      */ { "insertData",			"",					"",				""					}},
	{0x3b, /* ;      */ { "insertData",			"dlgSpell",			"",				""					}},
	{0x3c, /* <      */ { "insertData",			"fontSizeDecrease",	"",				"insertRLM"			}},
	{0x3d, /* =      */ { "insertData",			"toggleSub",   		"zoomIn",	""					}},
	{0x3e, /* >      */ { "insertData",			"fontSizeIncrease",	"",				"insertLRM"			}},
	{0x3f, /* ?      */ { "insertData",			"",					"",				""					}},
	{0x40, /* @      */ { "insertData",			"",					"",				""					}},
	{0x41, /* A      */ { "insertData",			"selectAll",		DO_NOT_USE,		""					}},
	{0x42, /* B      */ { "insertData",			"toggleBold",		DO_NOT_USE,		""					}},
	{0x43, /* C      */ { "insertData",			"copy",				"viewSplit",	""					}},
	{0x44, /* D      */ { "insertData",			"dlgFont",			"insDateTime",	""					}},
	{0x45, /* E      */ { "insertData",			"toggleMarkRevisions",	DO_NOT_USE,		""					}},
	...
	{0x4b, /* K      */ { "insertData",			"insertHyperlink",	DO_NOT_USE,		""					}},
	{0x4c, /* L      */ { "insertData",			"alignLeft",		DO_NOT_USE,		""					}},
	{0x4d, /* M      */ { "insertData",			"toggleUnIndent",	DO_NOT_USE,		""					}},
	{0x4e, /* N      */ { "insertData",			"setStyleNormal",	DO_NOT_USE,		""					}},
	{0x4f, /* O      */ { "insertData",			"fileOpen",			DO_NOT_USE,		""					}},
	{0x50, /* P      */ { "insertData",			"print",			"insPageNo",	""					}},
	{0x51, /* Q      */ { "insertData",			"clearParaFormatting",	DO_NOT_USE,	""					}},
	{0x52, /* R      */ { "insertData",			"alignRight",		DO_NOT_USE,		""					}},
	{0x53, /* S      */ { "insertData",			"fileSaveAs", 		DO_NOT_USE,		"viewSplit"			}},
	{0x54, /* T      */ { "insertData",			"toggleOline",		DO_NOT_USE,		""					}},
	{0x55, /* U      */ { "insertData",			"toggleUline",		"insertSumCols",	""				}},
	{0x56, /* V      */ { "insertData",			"formatPainter",	DO_NOT_USE,		"pasteSpecial"	}},
	{0x57, /* W      */ { "insertData",			"closeWindow",		DO_NOT_USE,		""					}},
	{0x58, /* X      */ { "insertData",			"toggleStrike",		"refMarkEntry",	""					}},
	{0x59, /* Y      */ { "insertData",			"redo",				DO_NOT_USE,		""					}},
	{0x5a, /* Z      */ { "insertData",
#ifdef __APPLE__
						  "redo",				/* Cmd+Shift+Z = redo on macOS */
#else
						  "undo",				/* Ctrl+Shift+Z = undo */
#endif
													DO_NOT_USE,		""					}},
	...
	{0x5f, /* _      */ { "insertData",			"insertNBHyphen",	"",				"insertEnDash"		}},
	{0x60, /* `      */ { "insertData",			"removeFooter",		"",				""					}},
	{0x61, /* a      */ { "insertData",			"selectAll",		DO_NOT_USE,		"insAnnotation"		}},
	{0x62, /* b      */ { "insertData",			"toggleBold",		DO_NOT_USE,		""					}},
	{0x63, /* c      */ { "insertData",			"copy",				DO_NOT_USE,		"insertCopyright"	}},
	{0x64, /* d      */ { "insertData",			"dlgFont",			DO_NOT_USE,		"insEndnote"		}},
	{0x65, /* e      */ { "insertData",			"alignCenter",		DO_NOT_USE,		""					}},
	{0x66, /* f      */ { "insertData",			"find",				DO_NOT_USE,		"insFootnote"		}},
	...
	{0x6b, /* k      */ { "insertData",			"insertHyperlink",	DO_NOT_USE,		""					}},
	{0x6c, /* l      */ { "insertData",			"alignLeft",		DO_NOT_USE,		""					}},
	{0x6d, /* m      */ { "insertData",			"toggleIndent",		DO_NOT_USE,		"insAnnotation"		}},
	...
	{0x76, /* v      */ { "insertData",			"paste",			DO_NOT_USE,		"pasteSpecial"		}},
