...
//  					  _A,					_A_S,				_A_C,			_A_C_S				}},
	...
	{EV_NVK_LEFT,		{ "warpInsPtLeft",		"extSelLeft",		"warpInsPtBOW",	"extSelBOW",
						  "toggleUnIndent",		"",					"tableColNarrower",	""				}},
...
//	{char, /* desc   */ { none,					_C,					_A,				_A_C				}},
	...
	{0x6d, /* m      */ { "insertData",			"insSymbol",		DO_NOT_USE,		"insAnnotation"		}},
	{0x6e, /* n      */ { "insertData",			"fileNew",			DO_NOT_USE,		"nextComment"		}},
	{0x6f, /* o      */ { "insertData",			"fileOpen",			DO_NOT_USE,		""					}},
	{0x70, /* p      */ { "insertData",			"print",			DO_NOT_USE,		"prevComment"		}},
