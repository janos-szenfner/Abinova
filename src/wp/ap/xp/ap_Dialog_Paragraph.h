...
class ABI_EXPORT AP_Dialog_Paragraph : public XAP_Dialog_NonPersistent
{
 ...
 public:
	...
	enum tAlignState: uint8_t { align_UNDEF = 0, align_LEFT, align_CENTERED, align_RIGHT, align_JUSTIFIED };
	enum tIndentState: uint8_t { indent_UNDEF = 0, indent_NONE, indent_FIRSTLINE, indent_HANGING };
	enum tSpacingState: uint8_t { spacing_UNDEF = 0, spacing_SINGLE, spacing_ONEANDHALF, spacing_DOUBLE,
	...
	enum tControl: uint8_t { id_MENU_ALIGNMENT = 0, id_SPIN_LEFT_INDENT,
	...
	enum tOperation: uint8_t { op_INIT = 0, op_UICHANGE, op_SYNC };
