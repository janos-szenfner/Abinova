...
class ABI_EXPORT AP_Preview_Paragraph_Block
{
 public:
	...
	void setText(const UT_UCS4Char * text);
...
class ABI_EXPORT AP_Preview_Paragraph : public XAP_Preview
{
 public:
	...
	AP_Preview_Paragraph(GR_Graphics * gc, const UT_UCS4Char * text,
			     AP_Dialog_Paragraph * parent, const char * fontname = nullptr);
 ...
 protected:
	...
	virtual bool _loadDrawFont(const char *name = nullptr);
