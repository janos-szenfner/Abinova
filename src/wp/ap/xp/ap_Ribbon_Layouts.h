...
{
	AP_RIBBON_MENU_L(AP_MENU_ID_INSERT_FOOTNOTE),
	AP_RIBBON_MENU_L(AP_MENU_ID_INSERT_ENDNOTE),
	AP_RIBBON_MENUPOP_S(AP_MENU_ID_REF_NEXTFN),
...
{
	AP_RIBBON_MENUPOP_L(AP_MENU_ID_REF_CITATION),
	AP_RIBBON_MENUPOP_S(AP_MENU_ID_REF_SOURCES),
...
{
	AP_RIBBON_MENUPOP_L(AP_MENU_ID_REF_CAPTION),
	AP_RIBBON_MENUPOP_L(AP_MENU_ID_REF_TOF),
	AP_RIBBON_MENUPOP_L(AP_MENU_ID_REF_XREF),
	AP_RIBBON_END
};

static const AP_RibbonItem s_ribbon_references_index[] =
{
	AP_RIBBON_MENUPOP_L(AP_MENU_ID_REF_MARKENTRY),
	AP_RIBBON_MENU_L(AP_MENU_ID_REF_INSERTINDEX),
...
{
	AP_RIBBON_MENUPOP_L(AP_MENU_ID_REF_MARKCIT),
	AP_RIBBON_MENU_L(AP_MENU_ID_REF_INSERTTOA),
