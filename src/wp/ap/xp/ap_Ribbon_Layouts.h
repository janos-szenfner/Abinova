...
{
	AP_RIBBON_MENU_LS(AP_MENU_ID_TOOLS_ANNOTATIONS_INSERT),
	AP_RIBBON_MENUPOP_LS(AP_MENU_ID_TOOLS_ANNOTATIONS_MENUPOP_DELETE),
	AP_RIBBON_MENU_LS(AP_MENU_ID_TOOLS_ANNOTATIONS_RESOLVE),
	AP_RIBBON_MENU_LS(AP_MENU_ID_TOOLS_ANNOTATIONS_PREV),
	AP_RIBBON_MENU_LS(AP_MENU_ID_TOOLS_ANNOTATIONS_NEXT),
	AP_RIBBON_MENUPOP_LS(AP_MENU_ID_TOOLS_ANNOTATIONS_MENUPOP_SHOW),
	AP_RIBBON_END
};
