...
#define AP_RIBBON_MENU_LSW(x)	{ AP_RIBBON_ITEM_MENU,    (uint8_t)(AP_RIBBON_FLAG_LARGE | AP_RIBBON_FLAG_SLIM | AP_RIBBON_FLAG_WRAP), (uint16_t)(x) }
...
static const AP_RibbonItem s_ribbon_table_table[] =
{
	...
	AP_RIBBON_MENU_LSW(AP_MENU_ID_TABLE_DRAW),
	AP_RIBBON_MENU_LS(AP_MENU_ID_TABLE_ERASE),
	AP_RIBBON_MENUPOP_LS(AP_MENU_ID_TABLE_DELETE),
	AP_RIBBON_END
};

/* Writer-style large buttons in a row: Insert Above | Insert Below |
 * Insert Left | Insert Right | Merge Cells | Split Cells | Split Table */
static const AP_RibbonItem s_ribbon_table_rowscols[] =
{
	AP_RIBBON_MENU_L(AP_MENU_ID_TABLE_INSERT_ROWS_BEFORE),
	AP_RIBBON_MENU_L(AP_MENU_ID_TABLE_INSERT_ROWS_AFTER),
	AP_RIBBON_MENU_L(AP_MENU_ID_TABLE_INSERT_COLUMNS_BEFORE),
	AP_RIBBON_MENU_L(AP_MENU_ID_TABLE_INSERT_COLUMNS_AFTER),
	AP_RIBBON_MENUPOP_L(AP_MENU_ID_TABLE_MERGE_CELLS),
	AP_RIBBON_MENUPOP_L(AP_MENU_ID_TABLE_SPLIT_CELLS),
	AP_RIBBON_MENU_L(AP_MENU_ID_TABLE_SPLIT_TABLE),
	AP_RIBBON_END
};
...
static const AP_RibbonItem s_ribbon_table_align[] =
{
	...
	AP_RIBBON_MENUPOP_L(AP_MENU_ID_TABLE_TEXT_DIRECTION),
	AP_RIBBON_MENUPOP_L(AP_MENU_ID_TABLE_CELL_MARGINS),
	AP_RIBBON_END
};

static const AP_RibbonItem s_ribbon_table_data[] =
{
	AP_RIBBON_MENUPOP_LS(AP_MENU_ID_TABLE_SORT),
...
static const AP_RibbonItem s_ribbon_help_items[] =
{
	...
	AP_RIBBON_MENU_L(AP_MENU_ID_HELP_CHANGELOG),
