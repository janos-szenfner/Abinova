...
static const AP_RibbonItem s_ribbon_review_comments[] =
{
	...
	AP_RIBBON_MENUPOP_S(AP_MENU_ID_TOOLS_ANNOTATIONS_MENUPOP_DELETE),
	AP_RIBBON_MENU(AP_MENU_ID_TOOLS_ANNOTATIONS_RESOLVE),
	AP_RIBBON_MENU(AP_MENU_ID_TOOLS_ANNOTATIONS_PREV),
	AP_RIBBON_MENU(AP_MENU_ID_TOOLS_ANNOTATIONS_NEXT),
	AP_RIBBON_MENUPOP_S(AP_MENU_ID_TOOLS_ANNOTATIONS_MENUPOP_SHOW),
	AP_RIBBON_END
};
...
static const AP_RibbonItem s_ribbon_review_tracking[] =
{
	...
	AP_RIBBON_MENUPOP_S(AP_MENU_ID_TOOLS_REVISIONS_MENUPOP_ACCEPT),
	AP_RIBBON_MENUPOP_S(AP_MENU_ID_TOOLS_REVISIONS_MENUPOP_REJECT),
...
{
	AP_RIBBON_MENU_L(AP_MENU_ID_TOOLS_REVISIONS_COMPARE_DOCUMENTS),
	AP_RIBBON_END
};

static const AP_RibbonItem s_ribbon_review_ink[] =
{
	AP_RIBBON_DEAD(AP_RIBBON_DEAD_HIDEINK),
	AP_RIBBON_END
};
