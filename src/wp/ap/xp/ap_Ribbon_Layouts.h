...
{
	AP_RIBBON_MENU_L(AP_MENU_ID_EDIT_PASTE),
...
{
	AP_RIBBON_MENU_I(AP_MENU_ID_ALIGN_LEFT),
	AP_RIBBON_MENU_I(AP_MENU_ID_ALIGN_CENTER),
	AP_RIBBON_MENU_I(AP_MENU_ID_ALIGN_RIGHT),
	AP_RIBBON_MENU_I(AP_MENU_ID_ALIGN_JUSTIFY),
...
{
	AP_RIBBON_TB_I(AP_TOOLBAR_ID_LISTS_BULLETS),
	AP_RIBBON_TB_I(AP_TOOLBAR_ID_LISTS_NUMBERS),
	AP_RIBBON_TB_I(AP_TOOLBAR_ID_LISTS_DASHED),
...
{
	AP_RIBBON_MENU_L(AP_MENU_ID_EDIT_FIND),
	AP_RIBBON_MENU_L(AP_MENU_ID_EDIT_REPLACE),
	AP_RIBBON_MENU_L(AP_MENU_ID_EDIT_SELECTALL),
