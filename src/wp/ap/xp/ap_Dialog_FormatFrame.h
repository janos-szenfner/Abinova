...
public:
	...
	enum tAnswer: uint8_t { a_OK, a_CLOSE };
	enum toggle_button: uint8_t { toggle_left, toggle_right, toggle_top, toggle_bottom };
	...
	void setBorderColorAll(const UT_RGBColor& clr);
