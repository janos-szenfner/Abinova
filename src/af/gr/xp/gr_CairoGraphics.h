...
public:
	...
	virtual UT_sint32 measureUnRemappedChar(const UT_UCS4Char c, UT_uint32 * height = nullptr) override;
	...
	virtual UT_uint32      measureString(const UT_UCS4Char* s, int iOffset,
