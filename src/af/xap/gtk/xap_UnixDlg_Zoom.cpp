...
{
	m_currentZoomType = XAP_Frame::z_200;
...
{
	m_currentZoomType = XAP_Frame::z_100;
	_enablePercentSpin(false);
...
{
	m_currentZoomType = XAP_Frame::z_75;
	_enablePercentSpin(false);
...
{
	m_currentZoomType = XAP_Frame::z_PAGEWIDTH;
	_enablePercentSpin(false);
	if ( m_pFrame )
...
{
	m_currentZoomType = XAP_Frame::z_WHOLEPAGE;
	_enablePercentSpin(false);
	if ( m_pFrame )
...
{
	m_currentZoomType = XAP_Frame::z_PERCENT;
