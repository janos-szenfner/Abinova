...
void XAP_Dialog_FontChooser::setDrawString(const UT_UCS4Char * str)
{
	FREEP(m_drawString);
 ...
 */
void XAP_Dialog_FontChooser::event_previewInvalidate(const UT_UCS4Char * pszChars)
{
	UT_UCS4Char * pszNew = nullptr;
