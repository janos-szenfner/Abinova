 ...
 * font names (LibreOffice style - typing filters live) followed by an
 * arrow button opening a popover under the field whose lazy list
 * shows every font in its own typeface. */
struct AbiFontCombo {
	GtkBox			 parent;
	GtkWidget		*entry;
	GtkWidget		*arrow;
