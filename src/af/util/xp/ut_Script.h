...
private:
	UT_Script(const UT_Script &) = delete;
	UT_Script& operator=(const UT_Script &) = delete;
};
...
private:
	...
	UT_ScriptLibrary(const UT_ScriptLibrary&) = delete;
	UT_ScriptLibrary& operator=(const UT_ScriptLibrary&) = delete;
