...
//! PieceTable states
enum PTState: uint8_t { PTS_Create=0, PTS_Loading=1, PTS_Editing=2 };
//! ChangeFormat types
enum PTChangeFmt: uint8_t
{
  PTC_AddFmt = 0,
  PTC_RemoveFmt = 1,
  PTC_AddStyle = 2,
