...
{
	UT_ASSERT(m_sLastContainerLayout.size() == 1);
}
...
{
	m_sLastContainerLayout.push(pCL);
}
...
{
	return m_sLastContainerLayout.top();
}
...
{
	fl_ContainerLayout * pCL = m_sLastContainerLayout.top();
	m_sLastContainerLayout.pop();
	return pCL;
}
