...
XAP_Dialog_Id ServiceAccountHandler::m_iDialogGenericInput = static_cast<XAP_Dialog_Id>(0);
XAP_Dialog_Id ServiceAccountHandler::m_iDialogGenericProgress = static_cast<XAP_Dialog_Id>(0);
