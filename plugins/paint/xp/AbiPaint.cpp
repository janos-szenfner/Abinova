...
{
  { ABI_PLUGIN_METHOD_STR(submenu_start), nullptr,                           "AbiPaint",                   "Allows in place editing of image via external program.", EV_MLF_BeginSubMenu, true, false, false, nullptr, nullptr, true, false, (XAP_Menu_Id)0 },
  { ABI_PLUGIN_METHOD_STR(editImage),     ABI_PLUGIN_METHOD(editImage),   "(AbiPaint) &Edit Image",     "Opens the selected image for modification (in specified image editing program).", EV_MLF_Normal, false, true, false, ABI_GRAYABLE_MENUITEM(editImage), getEditImageMenuName, true, true, (XAP_Menu_Id)0 },
#ifdef ENABLE_BMP
  { ABI_PLUGIN_METHOD_STR(saveAsBmp),     ABI_PLUGIN_METHOD(saveAsBmp),   "Save Image &As BMP",         "Saves the selected image as a BMP file.", EV_MLF_Normal, false, true, false, ABI_GRAYABLE_MENUITEM(editImage), nullptr, true, true, (XAP_Menu_Id)0 },
#endif
  { ABI_PLUGIN_METHOD_STR(separator1),    nullptr,                           nullptr,                         nullptr, EV_MLF_Separator, false, false, false, nullptr, nullptr, true, false, (XAP_Menu_Id)0 },
  { ABI_PLUGIN_METHOD_STR(specify),       ABI_PLUGIN_METHOD(specify),     "&Specify Image Editor",      "Allows you to specify what image editing program to use, results stored in registry.", EV_MLF_Normal, false, true, false, nullptr, nullptr, true, false, (XAP_Menu_Id)0 },
#ifdef ENABLE_BMP
  { ABI_PLUGIN_METHOD_STR(useBmp),        ABI_PLUGIN_METHOD(useBmp),      "Image Editor Requires &BMP", "Indicates the specified image editing program must use a BMP file instead of PNG (default is enabled).", EV_MLF_Normal, false, false, true, ABI_TOGGLEABLE_MENUITEM(useBmp), nullptr, true, false, (XAP_Menu_Id)0 },
#endif
  { ABI_PLUGIN_METHOD_STR(submenu_end),   nullptr,                           "AbiPaint Submenu End",       nullptr, EV_MLF_EndSubMenu, true, false, false, nullptr, nullptr, true, false, (XAP_Menu_Id)0 },
} ;
...
bool doRegistration(void)
{
    ...
    addToMenus(amo, NUM_MENUITEMS, (XAP_Menu_Id)AP_MENU_ID_TOOLS_WORDCOUNT, (XAP_Menu_Id)AP_MENU_ID_CONTEXT_IMAGE);
