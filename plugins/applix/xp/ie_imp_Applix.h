...
protected:
 ...
 private:
	...
	static short            s_8bitsToUCS (const char *str, size_t len, UT_UCS4Char * c);
	static short            s_16bitsToUCS (const char *str, size_t len, UT_UCS4Char * c);
	static short            s_decodeToUCS (const char *str, size_t len, UT_UCS4Char * c);
