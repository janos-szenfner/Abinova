...
#line 469 "post-process/pp_lexer.c"

#line 471 "post-process/pp_lexer.c"
...
YY_DECL
{
	...
	{
#line 43 "post-process/pp_lexer.l"


#line 738 "post-process/pp_lexer.c"
...
case 3:
YY_RULE_SETUP
#line 48 "post-process/pp_lexer.l"
{ set_label(yyextra, yytext); }
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 49 "post-process/pp_lexer.l"
{ add_set_of_strings_to_label(yyextra, &(yytext[1])); }
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 50 "post-process/pp_lexer.l"
{ add_string_to_label(yyextra, yytext); }
	YY_BREAK
case 6:
YY_RULE_SETUP
#line 51 "post-process/pp_lexer.l"
{ add_string_to_label(yyextra, yytext); }
	YY_BREAK
case 7:
YY_RULE_SETUP
#line 53 "post-process/pp_lexer.l"
{ prt_error("pp_lexer: unable to parse knowledge file (line %i).\n", yylineno); }
	YY_BREAK
case 8:
YY_RULE_SETUP
#line 56 "post-process/pp_lexer.l"
ECHO;
	YY_BREAK
#line 840 "post-process/pp_lexer.c"
